 ...
 */
/*
 *  Wejœcie: empeka01.01.21jabber.papla.pl
 *  Wyjœcie: 4f01a52295996c7e147f1d1f45887e7145eaa27b
 */
...
public final class SHA1 {
    ...
    public static void main(String args[]) {
        ...
        if (args.length>0){
            s.init();
            s.updateASCII(args[0]);
            s.finish();
            
            System.out.println("Wejœcie: "+args[0]);
            System.out.println("Wyjœcie: "+s.digout());
