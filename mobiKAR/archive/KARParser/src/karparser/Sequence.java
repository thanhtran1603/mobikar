...
public class Sequence {
     ...
     * @see #getTracks
     */
    public Sequence(float divisionType, int resolution) throws Exception {
	...
	else throw new Exception("Unsupported division type: " + divisionType);
     ...
     * @see #getResolution
     */
    public Sequence(float divisionType, int resolution, int numTracks) throws Exception {
