<?php
// TODO: - Ja tu wstawiłem koda
include_once('config.php');
// --------------------------------------------------------------------------------
// PhpConcept Library - Zip Module 2.4-RC1
// --------------------------------------------------------------------------------
...
//
// --------------------------------------------------------------------------------
// $Id: pclzip.lib.php,v 1.39 2005/06/07 20:56:47 vblavet Exp $
// --------------------------------------------------------------------------------
  ...
  define( 'PCLZIP_TEMPORARY_DIR', MOBIKAR_TEMPORARY_DIR );
// --------------------------------------------------------------------------------
// ***** UNDER THIS LINE NOTHING NEEDS TO BE MODIFIED *****
// --------------------------------------------------------------------------------

  // ----- Global variables
  $g_pclzip_version = "2.4-RC1";
...
//    $p_header['external'] = (is_file($p_filename)?0xFE49FFE0:0x41FF0010);
  ...
  function privList(&$p_list)
  {
    ...
    for ($i=0; $i<$v_central_dir['entries']; $i++)
    {
      ...
      if (!isset($v_header)) $v_header = null;
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++)
    {
      ...
      if ($v_extract)
      {
        ...
        if ($p_options[PCLZIP_OPT_EXTRACT_AS_STRING]) {
          ...
          // ----- Extracting the file
          if (!isset($v_string)) $v_string = null;
...
//      if ($p_entry['compressed_size'] == $p_entry['size'])
  ...
  function privMerge(&$p_archive_to_add)
  {
    ...
    if (($v_result = $this->privWriteCentralHeader($v_central_dir['entries']+$v_central_dir_to_add['entries'], $v_size, $v_offset, $v_comment)) != 1)
    {
      ...
      // ----- Reset the file list
      if (!isset($v_header_list)) $v_header_list = null;
      unset($v_header_list);
